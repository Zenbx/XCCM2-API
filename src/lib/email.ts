        ...
        await transporter.sendMail({
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                    ...
                    <p style="color: #666; line-height: 1.6;">
                        Si vous avez des questions, n'hésitez pas à nous <a href="${process.env.FRONTEND_URL || process.env.NEXT_PUBLIC_BASE_URL}/contact" style="color: #0066cc; text-decoration: none;">contacter</a>.
                    </p>
